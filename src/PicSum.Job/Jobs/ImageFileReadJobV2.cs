...
{
    public sealed class ImageFileReadJobV2
        : AbstractTwoWayJob<ImageFileReadParameter, ImageFileGetResultV2>
    {
        private static void ExeptionHandler(ImageFileGetResultV2 result)
        {
        ...
        protected override void Execute(ImageFileReadParameter parameter)
        {
            ...
            var mainResult = new ImageFileGetResultV2();
            var subResult = new ImageFileGetResultV2();
